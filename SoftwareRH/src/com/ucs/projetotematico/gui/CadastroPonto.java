...
public class CadastroPonto extends JFrame implements ActionListener {
	 ...
	 * Create the frame.
	 */
	public CadastroPonto() throws ParseException {		
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(CadastroPonto.class.getResource("/img/icone32.ico")));
		...
		btnEditar.setIcon(new ImageIcon(CadastroPonto.class.getResource("/img/IconBotaoEditar.ico")));
		...
		btnExcluir.setIcon(new ImageIcon(CadastroPonto.class.getResource("/img/IconBotaoExcluir.ico")));
		...
		btnSalvar.setIcon(new ImageIcon(CadastroPonto.class.getResource("/img/IconBotaoSalvar.ico")));
		btnSalvar.setBounds(495, 318, 32, 32);
		contentPane.add(btnSalvar);
		
		lblFundo = new JLabel("");
		lblFundo.setIcon(new ImageIcon(CadastroPonto.class.getResource("/img/fundo2.jpg")));
